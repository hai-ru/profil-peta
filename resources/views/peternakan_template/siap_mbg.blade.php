...
<head>
    ...
    <title>SIAP MBG PROVINSI KALIMANTAN BARAT</title>
    ...
    <link rel="shortcut icon" href="/img/favicon/siapmbg-favicon.ico" type="image/x-icon">
    <link rel="icon" href="/img/favicon/siapmbg-favicon.ico" type="image/x-icon">
...
<link href="https://fonts.googleapis.com/css2?family=Open+Sans:ital,wght@0,300..800;1,300..800&display=swap" rel="stylesheet">
    <style>
        ...
        .accordion-header{
         ...
         .navbar-custom {
            background-color: #5D7734; /* Warna hijau sesuai gambar */
        }
        .navbar-brand img {
            height: 50px;
        }
...
<body>
            ...
            <nav class="navbar navbar-expand-lg navbar-custom">
                <div class="container-fluid">
                    ...
                    <a class="navbar-brand" href="#">
                        <div class="nav-logo">
                            <img src="/img/siap_mbg_logo.png" alt="SIAP MBG">
                            <img src="/img/assets/logo_disbunak.png" class="logo-right me-2 logo_disbun" alt="DISBUNNAK KALBAR">
                        </div>
                        <div class="text_container">
                            <span class="text-white fw-bold fs-5">APLIKASI DATA ATRIBUT DAGING SUSU TELUR</span>
                            <br />
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapse0" class="accordion-collapse collapse show">
                                <div class="accordion-body">
                                    ...
                                    <div class="form-group">
                                        <label>Kecukupan</label>
                                        <select id="mbg" class="form-control">
                                            <option value="status_kecukupan_mbg_daging_sapi">Daging sapi</option>
                                            <option value="status_kecukupan_mbg_daging_ayam">Daging ayam</option>
                                            <option value="status_kecukupan_mbg_telur_ayam">Telur ayam</option>
                                        </select>
                                    </div>
    ...
    <script type="text/javascript">
        ...
        const loadData = (year) => {
            ...
            const link = `/siap-mbg/service?&kabupaten=${kabupaten}`;
            $.ajax({
                url:link,
                type:"GET",
                success:function(response){
                    ...
                    map.data.setStyle(function(feature){
                        let skoring = feature.getProperty(status) || "";
                        let warna = "#000";
                        switch (skoring) {
                            case 'tidak_cukup':
                                warna = "#f5ec42"
